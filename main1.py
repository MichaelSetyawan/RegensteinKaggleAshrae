...
weather_train=pd.read_csv('weather_train.csv',nrows=1000) #dim:139773 rows
...
building_metadata=pd.read_csv('building_metadata.csv',nrows=2000) #dim:
...
#Import train data
train=pd.read_csv('train.csv',nrows=3000)#dim:
